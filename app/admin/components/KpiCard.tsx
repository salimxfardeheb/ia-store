...
export function KPICard({ title, value, trend, isUp, subtitle }: KPICardProps) {
  return (
    ...
    >
      ...
      <p className="text-[10px] uppercase tracking-[0.35em] text-black/35 mb-5 font-serif" >
        {title}
      </p>
      ...
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-[9px] text-black/30 uppercase tracking-widest font-serif">
            {subtitle}
          </p>
        </div>

        <div
          className={`flex items-center space-x-1 px-2.5 py-1 text-[9px] uppercase tracking-widest border font-serif ${
            isUp
